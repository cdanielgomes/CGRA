...
class MyVehicle extends CGFobject {
    ...
    display() {
        ...
        this.scene.pushMatrix();
        this.scene.translate(-2.5 - this.x, 0.5,-1.5 + this.y);
        ...
        this.scene.pushMatrix();
        this.scene.translate(-2.5 - this.x, 0.5, 2 + this.y);
        ...
        //roda de tras
        this.scene.pushMatrix();
        this.scene.translate(2 - this.x, 0.5, -1.5 + this.y);
        ...
        this.scene.pushMatrix();
        this.scene.translate(2 - this.x, 0.5, 2 + this.y);
        this.wheel2.display();
        this.scene.popMatrix();
